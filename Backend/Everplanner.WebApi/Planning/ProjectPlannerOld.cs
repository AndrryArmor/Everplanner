...
public class ProjectPlannerOld
{
    private List<Task> _tasks;
    private List<Worker> _workers;
    private bool _isPlanned = false;

    public ProjectPlannerOld(int id, string name, IEnumerable<Task> tasks, IEnumerable<Worker> workers)
    {
        Id = id;
        Name = name;
        _tasks = tasks.ToList();
    ...
    public static ProjectPlannerOld BuildProject(ProjectRequestModel projectRequestModel)
    {
        ...
        return new ProjectPlannerOld(projectRequestModel.Id, projectRequestModel.Name, tasks, workers);
    }

    public static PlannedProjectDto ExportPlannedProject(ProjectPlannerOld project)
    {
        ...
        var workersForExport = project.Workers.Select(w => new PlannedWorkerDto(w.Id, w.Name));
        return new PlannedProjectDto(project.Id, project.Name, tasksForExport, workersForExport,
